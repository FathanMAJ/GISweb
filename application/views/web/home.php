                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li> <a href="#about">Mata Kuliah WebGIS</a> </li>
              ...
              <div class="carousel-caption">
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>Tugas WebGIS Pertemuan V</h1>
                      <p>Membuat Halaman web dengan Menampilkan peta yang telah dibuat</p>
                      <a href="#">Let's Start!</a> <a href="#">Selengkapnya..</a>
                    </div>
                  </div>
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?=base_url()?>assets/web/images/nazi.png"></figure>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <h2>Mata Kuliah <strong class="yellow">WebGIS</strong></h2>
          <p> Tugas webGIS sangat menyenangkan dan membuat mahasiswa lebih teliti dan rajin. Kali ini kami ditugaskan untuk membuat tampilan web dengan menampilkan peta yang telah dibuat pada pertemuan selanjutnya.</p>
          <p> semoga semua mendapat keberkahan ilmu serta mendapatkan nilai yang sangat baik berdasarkan usaha yang telah dilakukan</p>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage">
          ...
          <span>Cara belajar ilmu Coding untuk webGIS adalah dengan mempelajarinya melalui praktik yang dilaksanakan secara bertahap. Terdapat mata kuliah webGIS di Prodi Sains Informasi Geografi sebagai dasar pembelajaran untuk mengembangkan skill ini.</span>
        </div>
      </div>
    </div>
    <div class="row">
...
<div class="make">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage">
          <h2> Teknik Jitu <strong class="white_colo">Belajar Ilmu Coding untuk WebGIS</strong></h2>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_text">
          <p>Dengan mempelajari bahasa pemrograman web, menguasai framework webGIS, dan memahami teknik integrasi data geografis, Anda akan memiliki dasar yang kuat untuk mengembangkan ilmu coding WebGIS dengan lebih baik. Terus berlatih, mencoba proyek-proyek kecil, dan menjelajahi sumber daya online akan membantu Anda meningkatkan kemampuan Anda secara bertahap.
          </p>
          <a href="Javascript:void(0)">Ayo belajar!</a>
        </div>
      </div>
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_img">
